...
export const Artimgs = [
    ...
    {id:7, img: wolves, title: 'The Pack'},
    {id:8, img: whale, title: 'The Deep Dive'},
    {id:9, img: bridge, title: 'Rainy Night'},
    {id:10, img: cat, title: 'The CatMan'},
    {id:11, img: city, title: 'Level 1'},
    {id:12, img: desert, title: 'Lost in the Desert'},
    {id:13, img: sam, title: 'Fatality'},
    {id:14, img: wood, title: 'Foggy Woods'},
    {id:15, img: dragon, title: 'Uphill Battle'},
    {id:16, img: docs, title: 'Dive into Bliss'},
    {id:17, img: rsamurai, title: 'Red Warrior'},
    {id:18, img: guts, title: 'Solidarity'},
    {id:19, img: mount, title: 'The Peak'},
    {id:20, img: wait, title: 'The wait'},
    {id:21, img: wild, title: ' Queen in the wild'},
    {id:22, img: skull, title: 'Skull'},
    {id:23, img: planets, title: 'Drift Away'},
    {id:24, img: heatb, title: ' Heat blast x Sukuna'},
    {id:25, img: citygirl, title: ' Night' }, 
    {id:26, img: blossom, title: ' Pretty Weather'},  
    {id:27, img: clouds, title: 'The Ideal Peace'},  
    {id:28, img: cityblue, title: ' Calm Night'},  
    {id:29, img: train, title: 'The Journey'},  
    {id:30, img: butter, title: ' Metamorphosis'},             
]